  ...
  return {
    ...
    blocks: [
      ...
      // Age filter
      {
        ...
        block_id: "age_block",
        optional: true,
        label: { type: "plain_text", text: "When was it posted to #image-gen?" },
        element: {
          type: "static_select",
      ...
      // Freshness filter
      {
        ...
        optional: true,
        label: { type: "plain_text", text: "How much has it been used by sparagmos?" },
        element: {
          type: "static_select",
          ...
          options: [
            ...
            { text: { type: "plain_text", text: "Prefer fresh — not yet run with this recipe" }, value: "prefer_fresh_recipe" },
            { text: { type: "plain_text", text: "Only fresh — never run with this recipe" }, value: "only_fresh_recipe" },
            { text: { type: "plain_text", text: "Only remixes — already run with this recipe" }, value: "only_used_recipe" },
            { text: { type: "plain_text", text: "Prefer untouched — never run with any recipe" }, value: "prefer_untouched" },
            { text: { type: "plain_text", text: "Only untouched — never run with any recipe" }, value: "only_untouched" },
            { text: { type: "plain_text", text: "Only veterans — run with 3+ different recipes" }, value: "only_veterans" },
          ],
        },
      },
      // ── Tools section ──
